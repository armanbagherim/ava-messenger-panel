...
LABEL org.opencontainers.image.url=https://github.com/Awesome-Technologies/admin panel org.opencontainers.image.source=https://github.com/Awesome-Technologies/admin panel
